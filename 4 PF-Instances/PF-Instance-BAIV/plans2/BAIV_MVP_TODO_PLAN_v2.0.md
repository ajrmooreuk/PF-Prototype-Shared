...
- **Deployment:** DigitalOcean with PF-Core config management
...
1. **Authentication & Authorization** (PFC-SEC-Auth-Foundation, PFC-SEC-RBAC-Foundation)
   ...
   - Multi-tenant isolation (PFC-SEC-Multi-Tenant-Isolation)
...
2.0 Foundation Services
├── 2.1 Database Layer
│   ├── 2.1.1 PostgreSQL Setup (DigitalOcean Managed)
│   ├── 2.1.2 Schema Deployment (11 tables)
│   ├── 2.1.3 RLS Policies (6 tables)
│   └── 2.1.4 Seed Data (roles, agents)
├── 2.2 API Layer
│   ├── 2.2.1 Node.js/TypeScript Setup
│   ├── 2.2.2 Express Server
│   ├── 2.2.3 Database Connection Pool
│   └── 2.2.4 Health/Status Endpoints
├── 2.3 Authentication Service
│   ├── 2.3.1 User Registration
│   ├── 2.3.2 Login (JWT)
│   ├── 2.3.3 Session Management
│   └── 2.3.4 Middleware (JWT validation)
└── 2.4 Ontology Service
    ├── 2.4.1 CRUD Endpoints
...
│   ├── 5.1.1 DigitalOcean App Platform
│   ├── 5.1.2 Managed PostgreSQL
