...
**Registry:** Unified Registry Architecture (agents + ontologies + data contracts)
...
### P0.1.6 Unified Registry Integration **[NEW in v2.1.0]**
...
- Registry Sync: Automatic on tag push
- CI/CD Validation: Template v2.1.0 compliance check
...
### P0.3.5 Data Contract Registry Compliance **[NEW in v2.1.0]**
