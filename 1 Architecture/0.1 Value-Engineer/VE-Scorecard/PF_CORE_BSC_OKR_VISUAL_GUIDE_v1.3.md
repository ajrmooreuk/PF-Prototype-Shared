...
|---------|------|--------|---------|
| 1.0 | Dec 2025 | Platform Architect | Initial Configurable BSC Framework |
| 1.1 | Dec 2025 | Platform Architect | Renamed to BSC-OKR Framework, Power BI in scope, LOB integration philosophy |
| 1.2 | Dec 2025 | Platform Architect | Added explanatory narratives, scope benefits, backwards compatibility references |
| 1.3 | Dec 2025 | Platform Architect | Added Predictive Analytics & Forecasting (multi-horizon), Market & Sales Command Centre, Strategic Goal Achievement Engine (£1.2B example), Gate/Approval Workflows, Finance/Inventory Integration |
...
### 10.1 Enterprise Data Platform Architecture
