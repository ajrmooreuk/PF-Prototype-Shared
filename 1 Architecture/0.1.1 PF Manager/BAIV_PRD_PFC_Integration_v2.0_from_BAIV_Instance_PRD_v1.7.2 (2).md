...
| **Agentic Builder** | Context Engineer | *No BAIV Mapping - PFC Only* | P0 - Critical | Design context windows; Optimize prompt engineering |
...
Designs and optimizes context windows, prompt engineering, and agent memory management:

| Component | PFC Definition | Function |
|-----------|----------------|----------|
| **Context Window Design** | Token budget allocation | Optimize context for agent tasks |
| **Prompt Engineering** | System prompt creation | Craft effective agent instructions |
| **Memory Management** | Short/long-term memory | Manage conversation state |
| **Knowledge Injection** | RAG & retrieval patterns | Inject relevant knowledge |
| **Context Compression** | Token optimization | Maximize context efficiency |

```
Context Engineer Agent Responsibilities:
├── Context Architecture
│   ├── Define context window budgets
...
| Context Layer | Purpose | Token Budget | Agent Application |
|---------------|---------|--------------|-------------------|
| **System Prompt** | Agent identity & rules | 1,000-2,000 | Core instructions |
| **VSOM Context** | Strategic alignment | 500-1,000 | Objective awareness |
| **Ontology Context** | Domain knowledge | 1,000-3,000 | Semantic reasoning |
| **Conversation History** | Continuity | 2,000-8,000 | Multi-turn context |
| **Retrieved Knowledge** | RAG results | 2,000-5,000 | Factual grounding |
| **Task-Specific** | Current request | 1,000-2,000 | Immediate context |

**Context Engineering Patterns:**

```
Pattern 1: Hierarchical Context Injection
├── Level 1: Platform Context (PFC-wide)
├── Level 2: Instance Context (BAIV-specific)
├── Level 3: Module Context (Discovery, Gap, Content)
└── Level 4: Task Context (Current operation)

Pattern 2: Progressive Disclosure
├── Start: Minimal context for simple tasks
├── Expand: Add context as complexity increases
└── Compress: Summarize when limits approached

Pattern 3: Semantic Chunking
├── Ontology-aware document splitting
├── Entity-preserving boundaries
└── Relationship-maintaining chunks
```

**Context Quality Metrics:**
- Context Relevance Score: Minimum 0.8
- Token Efficiency: Target 85%+ utilization
- Retrieval Precision: Minimum 0.9
- Response Coherence: Validated against context
...
graph TB
    ...
    SOLA --> CTXE
    CTXE -.->|context patterns| ORQ
    CTXE -.->|prompt templates| AGT
    SOLB -.->|artifacts| VE
...
| **Context Engineer** | Agent responsible for context window design, prompt engineering, and memory management |
| **RAG** | Retrieval-Augmented Generation - knowledge injection pattern |
